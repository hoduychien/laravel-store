						...
						<div class="col-sm-8">
							<div class="single-item-body">
								...
								<p class="single-item-price">
									@if($sanpham->promotion_price==0)
										<span class="flash-sale" style="font-size: 30px;color: red;font-weight: bold;">{{number_format($sanpham->unit_price)}} đồng</span>
										<div class="space20">&nbsp;</div>
									@else
										<span class="flash-del" style="font-weight: bolder;">{{number_format($sanpham->unit_price)}} đồng</span><br>
										<br>
										<span class="flash-sale" style="font-size: 30px;color: red;font-weight: bold;">{{number_format($sanpham->promotion_price)}} đồng</span>
								...
								<div class="single-item">
									...
									<div class="single-item-body">
										...
										<p class="single-item-price" style="font-size: 18px">
											@if($sptt->promotion_price==0)
												<span class="flash-sale" style="text-align: center;">{{number_format($sptt->unit_price)}} đồng</span>
												<div class="space5">&nbsp;</div>
											@else
												<span class="flash-del"  style="text-align: center;">{{number_format($sptt->unit_price)}} đồng</span><br>
												<span class="flash-sale"  style="text-align: center;">{{number_format($sptt->promotion_price)}} đồng</span>
											@endif
											<div class="space5">&nbsp;</div>
										</p>
									</div>
									<div class="single-item-caption" >
										<a class="add-to-cart pull-left" style="margin-left: 10px; " href="{{route('themgiohang',$sptt->id)}}"><i class="fa fa-shopping-cart"></i></a>
